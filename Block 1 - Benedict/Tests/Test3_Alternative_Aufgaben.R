...
# Wir üben an einem konkreten Beispiel: Die Tordifferenz der letzten Spiele des FC Bayern (bis 19. April).
...
# Welche Klasse hat der Vektor namen_fcb?
...
# Damit wir die Werte in der richtigen Reihenfolge plotten können, müssen wir die Gegnerspalte als Factor definieren. Die Reihenfoolge der Levels muss die sein, die wir später plotten wollen (das erste Spiel des Jahres als erstes, das letzte als letztes)
df_fcb_diff$gegner <- 
...
##
## 
# Die Struktur des Datensatzes df_oktoberfest kennst Du ja schon. Lass uns herausfinden, in welchem Jahr am meisten Besucher kamen. Ordne den Datensatz so an, dass das Jahr mit den meisten Besuchern ganz oben steht. Speichere ihn in die Variable df_oktoberfest_besucher - und lasse sie dir anzeigen.
...
current_hour <- as.numeric(format())
