...
# Ändere die Spaltennamen des Dataframes zu c("zahlen", "buchstaben", "booleans")


#Gib die neuen Spaltennamen aus:


# Wie viele Spalten hat der Dataframe? Schreibe die Funktion, die Dir das berechnet.


# Wie viele Zeilen hat der Dataframe? Schreibe die Funktion, die Dir das berechnet.
...
# Ändere die Spaltennamen des Dataframes zu c("zahlen", "buchstaben", "booleans")
names(df) <- c("zahlen", "buchstaben", "booleans")
...
test_correct(test_object("df"), test_function("data.frame", args = c("numbers", "letters", "logicals")))

test_function("names")

test_function("ncol", args = c("x"))

test_function("nrow", args = c("x"))

test_output_contains(3, incorrect_msg = "Ist die Zahl der Spalten richtig ausgegeben?")
test_output_contains(10, incorrect_msg = "Ist die Zahl der Zeilen richtig ausgegeben?")
