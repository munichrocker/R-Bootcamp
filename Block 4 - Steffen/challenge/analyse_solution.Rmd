...
Die meisten Teilnehmer (insgesamt `r teilnehmer_hoechste$Teilnehmer`) hatten Aufmärsche im Jahr `r teilnehmer_hoechste$Jahr`. Im Jahr `r teilnehmer_niedrigste$Jahr` nahmen die wenigsten Teilnehmer `r anzahl_niedrigste$Teilnehmer` an rechtsextremen Demos teil.
