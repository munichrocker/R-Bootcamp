...
test_output_contains(c('as.POSIXct("14 April 2019", format = "%d %B %Y")', 'as.POSIXct("11.12.1990", format = "%d.%m.%Y")', 'as.POSIXct("2019-04-18")', 'as.POSIXct("04/23/2019", format = "%m/%d/%Y")'), incorrect_msg = "Hast Du alle Daten richtig ausgegeben?")
